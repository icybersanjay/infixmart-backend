...
console.log("[uploads] storage path:", uploadsDir, "| cwd:", process.cwd());
...
async function saveUploadedFiles(formData, fieldName) {
  ...
  for (const entry of entries) {
    ...
    console.log("[uploads] writing file:", fullPath, "size:", buffer.length);
    await fs.writeFile(fullPath, buffer);
    console.log("[uploads] saved:", fullPath);
