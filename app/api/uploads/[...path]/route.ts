...
async function resolveDiskPath(filename: string): Promise<string | null> {
  const candidates = [
...
async function serveUpload(_request: NextRequest, context: RouteContext, includeBody = true) {
